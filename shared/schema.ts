...
export const mstClient = mysqlTable("mst_client", {
  ...
  openingInvestment: decimal("opening_investment", { precision: 18, scale: 2 }),
  openingWithdrawl: decimal("opening_withdrawl", { precision: 18, scale: 2 }),
  openingPayout: decimal("opening_payout", { precision: 18, scale: 2 }),
  openingClosure: decimal("opening_closure", { precision: 18, scale: 2 }),
  isActive: tinyint("is_active").notNull(),
  createdById: int("created_by_id").notNull(),
  createdByUser: varchar("created_by_user", { length: 50 }).notNull(),
  createdDate: timestamp("created_date").notNull(),
