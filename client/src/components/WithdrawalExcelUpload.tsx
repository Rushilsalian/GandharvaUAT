...
export function WithdrawalExcelUpload({ onUploadComplete }: WithdrawalExcelUploadProps) {
  ...
  const downloadSample = () => {
    const sampleData = [
      { client_code: 'CLI001', date: '15-01-2024', amount: 25000, remark: 'Partial withdrawal' },
      { client_code: 'CLI002', date: '16-01-2024', amount: 15000, remark: 'Emergency withdrawal' },
      { client_code: 'CLI003', date: '17-01-2024', amount: 30000, remark: '' }
    ];
    ...
    <Card className="w-full">
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          Excel Upload - Withdrawal Transactions
        </CardTitle>
        <CardDescription>
          Upload Excel file with withdrawal transaction data. Indicator ID: 3 (Withdrawal)
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {result && (
          <Alert variant={result.errors.length === 0 ? "default" : "destructive"}>
            ...
            <AlertDescription>
              ...
              <div className="mt-2">
                <p>Successfully processed: {result.success} withdrawal transactions</p>
                {result.errors.length > 0 && (
                  <div className="mt-2">
        ...
        <div className="flex gap-2">
          <Button
            ...
            className="flex-1"
          >
            {uploading ? 'Uploading...' : 'Upload Withdrawal Transactions'}
          </Button>
          {(file || result) && (
